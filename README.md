_NOTE:_ Forked from [here](https://github.com/chatscope/chat-ui-kit-react) to update peerDependencies for React 19. If the original has been updated, or you are using React 18 or earlier, don't use this fork.
